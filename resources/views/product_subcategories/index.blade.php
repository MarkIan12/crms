...
<div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            ...
            <button type="button" class="btn btn-md btn-primary" name="add_product_subcategories" id="add_product_subcategories">Add Product Application</button>
            </h4>
