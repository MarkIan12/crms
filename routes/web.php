...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/customer-complaint/view/{id}', 'CustomerComplaintController@view')->name('customer-customer_complaint.view');
    Route::delete('delete_complaint/{id}', 'CustomerComplaintController@destroy')->name('customer-customer_complaint.destroy');
